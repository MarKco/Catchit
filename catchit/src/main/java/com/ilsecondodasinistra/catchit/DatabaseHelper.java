...
public class DatabaseHelper {
    ...
    public static List<Bus> getMoreTramToVenice(Context context, String dayForThisQuery, String operator, Date now) {
...
//                        Log.w("MoreTramToVenice", moreTramToVenice);
    ...
    public static List<Bus> getTramToVenice(Context context, String dayForThisQuery, String operator, Date now) {
...
//            Log.w("TramToVenice", tramToVenice);
    ...
    public static List<Bus> getMoreTramFromVenice(Context context, String dayForThisQuery, String operator, Date now) {
        db = openDatabase(context);
...
//                        Log.w("moreTramFromVenice", moreTramFromVenice);
    ...
    public static List<Bus> getTramFromVenice(Context context, String dayForThisQuery, String operator, Date now) {
...
//                        Log.w("TramFromVenice", tramFromVenice);
    ...
    public static List<Bus> getTramToStation(Context context, String dayForThisQuery, String operator, Date now) {
    ...
    public static List<Bus> getStationToSansovino(Context context, String dayForThisQuery, String operator, Date now) {
...
//                    Log.w("tramFromStation", tramFromStation);
    ...
    public static List<Bus> getSansovinoToStation(Context context, String dayForThisQuery, String operator, Date now) {
